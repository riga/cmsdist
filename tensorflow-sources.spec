...
BuildRequires: bazel
Requires: gcc protobuf java-env python cuda cudnn nccl libjpeg-turbo eigen nasm py2-numpy py2-enum34 py2-mock py2-wheel py2-keras-applications py2-keras-preprocessing py2-setuptools py2-future
...
BAZEL_EXTRA_OPTS="--action_env=PYTHONPATH=${PYTHON27PATH} --action_env=LD_LIBRARY_PATH --distinct_host_configuration=false"
